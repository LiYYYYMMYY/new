<%@page import="com.oracle.cars.model.Push"%>
...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <% List<Push> pushs=(List<Push>)request.getAttribute("pushs");
       for(Push p:pushs){
    %>
    <tr>
    <td class="center"><%=p.getHaibao() %></td>
    <td class="center"><%=p.getGuanggao() %></td>
    <td class="center"><%=p.getDaili() %></td>
    <td><div class="button-group"> <a class="button border-main" href="PushServlet?method=getPushInfo&haibao<%=p.getHaibao()%>"><span class="icon-edit"></span> 修改</a>
                                   <a class="button border-red" href="PushServlet?method=delete&haibao=<%=p.getHaibao() %>" onclick="return del(1,2)"><span class="icon-trash-o"></span> 删除</a> </div></td>
    </tr>
    <%} %>
  </table>
</div>
